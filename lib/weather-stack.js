...
class WeatherStack extends aws_cdk_lib_1.Stack {
    constructor(scope, id, props) {
        ...
        // Optionally enable method-level caching
        // (requires a cache cluster on the stage)
        const cfnStage = restApi.deploymentStage.node.defaultChild;
        cfnStage.cacheClusterEnabled = true;
        cfnStage.cacheClusterSize = '0.5'; // Smaller cache node size for cost optimization
    }
}
